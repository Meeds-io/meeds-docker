...
| MEEDS_FILE_UMASK             | NO        | `0022`                       | the umask used for files generated by eXo                                                    |
...
| MEEDS_DB_TIMEOUT            | NO        | `60`          | the number of seconds to wait for database availability before cancelling eXo startup |
...
| MEEDS_ES_TIMEOUT          | NO        | `60`           | the number of seconds to wait for elasticsearch availability before cancelling eXo startup (only if MEEDS_ES_EMBEDDED=false)                                                                                                                                                     |
...
| VARIABLE               | MANDATORY | DEFAULT VALUE             | DESCRIPTION                                         |
|------------------------|-----------|---------------------------|-----------------------------------------------------|
| MEEDS_MAIL_FROM          | NO        | `noreply@exoplatform.com` | "from" field of emails sent by Meeds Server         |
...
| MEEDS_REWARDS_WALLET_TOKEN_ADDRESS              | NO        | `0xc76987d43b77c45d51653b6eb110b9174acce8fb`                     | address of the contract for the official rewarding token promoted by eXo                                                                                                                                                          |                                                                                                  |
